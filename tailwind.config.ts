  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'slide-in-from-top': 'slide-in-from-top 1s ease-in-out',
        ...
        'slide-out-to-top': 'slide-out-to-top 1s ease-in-out',
        'slide-out-to-bottom': 'slide-out-to-bottom 1s ease-in-out',
        'slide-out-to-left': 'slide-out-to-left 1s ease-in-out',
        'slide-out-to-right': 'slide-out-to-right 1s ease-in-out',
      },
    },
  },
